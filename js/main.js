...
function runHoroScope() {
    ...
    if ((bMonth === "January" && bDay >= 20) || (bMonth === "February" && bDay <= 18)) {
        ...
        insertSign.innerHTML = "<img src=\"../images/002-aquarius.png\" width=\"64px\" height=\"64px\">";
        ...
        insertSign.innerHTML = "<img src=\"../images/011-pisces.png\" width=\"64px\" height=\"64px\">";
        ...
        insertSign.innerHTML = "<img src=\"../images/006-aries.png\" width=\"64px\" height=\"64px\">";
        ...
        insertSign.innerHTML = "<img src=\"../images/002-taurus.png\" width=\"64px\" height=\"64px\">";
        ...
        insertSign.innerHTML = "<img src=\"../images/003-gemini.png\" width=\"64px\" height=\"64px\">";
        ...
        insertSign.innerHTML = "<img src=\"../images/005-cancer.png\" width=\"64px\" height=\"64px\">";
        ...
        insertSign.innerHTML = "<img src=\"../images/012-leo.png\" width=\"64px\" height=\"64px\">";
        ...
        insertSign.innerHTML = "<img src=\"../images/001-virgo.png\" width=\"64px\" height=\"64px\">";
        ...
        insertSign.innerHTML = "<img src=\"../images/009-libra.png\" width=\"64px\" height=\"64px\">";
        ...
        insertSign.innerHTML = "<img src=\"../images/008-scorpio.png\" width=\"64px\" height=\"64px\">";
        ...
        insertSign.innerHTML = "<img src=\"../images/010-sagittarius.png\" width=\"64px\" height=\"64px\">";
        ...
        insertSign.innerHTML = "<img src=\"../images/004-capricorn.png\" width=\"64px\" height=\"64px\">";
    } 
